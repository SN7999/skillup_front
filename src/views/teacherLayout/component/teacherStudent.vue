...
import {
  getStudentAPI,
  getSearchStudentListByClassAPI,
  getSearchStudentListByStudentAPI,
  searchStudentInfoAPI,
  getStudentsAPI
} from '@/apis/teacherStudentAPI'
...
<template>
  <div>
    ...
    <div class="searchBox" style="display: flex; align-items: center; margin-top: 10px;">
      <el-input v-model.trim="searchByClassName" class="w-50 m-2" size="large" placeholder="请输入课程名称" :prefix-icon="Search" @keyup.enter="getSearchByClassName" style="width: 30%; margin-right: 10px;" />
