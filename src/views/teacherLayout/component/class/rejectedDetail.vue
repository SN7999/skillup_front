...
const getClassDetail = async (classid) => {
    ...
    if(detail.value.endtime){
        ...
        // 转换为目标格式
        const formattedDate1 = `${dayOfWeek1} ${month1} ${day1} ${year1} ${hours1.toString().padStart(2, '0')}:${minutes1.toString().padStart(2, '0')}:${seconds1.toString().padStart(2, '0')} GMT${getTimezoneOffset(timezoneOffset1)}`;
    ...
    if(detail.value.starttime){
        ...
        // 转换为目标格式
        const formattedDate2 = `${dayOfWeek2} ${month2} ${day2} ${year2} ${hours2.toString().padStart(2, '0')}:${minutes2.toString().padStart(2, '0')}:${seconds2.toString().padStart(2, '0')} GMT${getTimezoneOffset(timezoneOffset2)}`;
